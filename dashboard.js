...
const data = [
 ...
 {n:"Yooz", o:"Yooz · Aimargues, France", stance:"ai", sl:"AI + fraud", prox:"Medium",
  ...
  s:[["7,000 customers (Sept 2, 2026)","https://www.globenewswire.com/news-release/2026/09/02/3355285/0/en/yooz-surpasses-7-000-customers-worldwide-as-platform-usage-hits-record-high.html"],["Yooz","https://www.getyooz.com/"],["YoozProtect","https://www.getyooz.com/blog/yooz-protect-launch"],["Yooz + BC/GP","https://msdynamicsworld.com/blog/two-days-two-erps-how-yooz-powering-ap-automation-gp-and-business-central"]]},
 ...
 {n:"Stampli", o:"Stampli · Mountain View", stance:"ai", sl:"AI veteran", prox:"Low",
  ...
  rel:"Stampli Deep Finance (Mar 2026) turns invoice data into consultant-grade executive spend intelligence; Stampli Card / Direct Pay; $61M Blackstone Series D (~$148M total); named a G2 Summer 2026 Leader for P2P + AP Automation (Jun 17, 2026) with an AP satisfaction score of 99.",
 ...
 {n:"DocuWare", o:"DocuWare (Ricoh) · Germering", stance:"ai", sl:"IDP + AI Hub", prox:"Medium",
  ...
  head:"Ricoh-owned document management at scale — 1,734 staff, 21,000+ customers — pushing IDP and e-invoicing into the same AP capture space as Document Capture.",
  ...
  ai:"IDP handles unstructured and poor-quality scans; a separate AI Hub signals a longer roadmap than a single feature release.",
  sc:"1,734 employees · 21,000+ customers · 100+ countries · 800+ partners · Ricoh subsidiary",
  s:[["IDP validation in web client (Aug 2026)","https://start.docuware.com/blog/product-news/docuware-idp-result-validation-in-web-client"],["Web Workflow Designer transition","https://start.docuware.com/blog/product-news/transition-to-docuwares-web-based-workflow-designer"],["DocuWare","https://start.docuware.com/"],["Gartner MQ Challenger","https://start.docuware.com/press-center/docuware-named-challenger-in-2026-gartner-magic-quadrant-for-document-management"],["DocuWare IDP","https://start.docuware.com/press-center/docuware-introduces-intelligent-document-processing-docuware-idp"],["2025/26 roadmap","https://start.docuware.com/blog/product-news/all-about-docuware-in-2025/26"],["Ricoh acquisition","https://www.ricoh-europe.com/news-events/news/ricoh-completes-acquisition-of-docuware/"]]}
];
...
const events = [
 ...
 {w:"Sept 30, 2026", c:"ai", t:"<b>Rillion</b> retires <b>PaletteArena</b> — end of life for the legacy Palette platform, with Rillion Prime as the migration target; a forced migration that puts thousands of Nordic AP installations in play."},
 ...
 {w:"Sept 15, 2026", c:"ai", t:"<b>Payhawk</b> ships its Fall \u201926 release \u2014 agentic \u201cPlaybooks\u201d that close the books, chase receipts, run budget control and prep audits end to end from inside Claude or ChatGPT over an MCP connection, plus an Implementation Agent that wires up ERP and HR systems. <b>Microsoft Dynamics</b> is on the supported-ERP list."},
 {w:"Sept 15, 2026", c:"ai", t:"<b>The MCP wave hits expense in twelve days</b> \u2014 <b>Rydoo</b> (Sept 3), <b>Pleo</b> (Sept 9), <b>Payhawk</b> and <b>Expensify</b> (both Sept 15, the latter into Claude for Small Business) all ship assistant-side access to expense, card and approval data. Conversational access is turning from differentiator into table stakes."},
 {w:"Sept 15, 2026", c:"cons", t:"<b>Sovos</b> acquires <b>Blue dot</b>, the Tel Aviv AI VAT-intelligence and recovery platform (150+ purpose-built models, agentic workflows, a VAT-reclaim business distributed through SAP Concur). Terms undisclosed \u2014 the second capability tuck-in of the month after Basware/Trustpair."},
 {w:"Sept 14, 2026", c:"steady", t:"<b>IDC</b> publishes its first Worldwide Compliant e-Invoicing MarketScape. <b>Thomson Reuters (ONESOURCE Pagero)</b> is a Leader across all four compliance categories; <b>Avalara</b> and <b>Sovos</b> are Leaders too. The category finally gets a shared analyst reference point."},
 {w:"Sept 12, 2026", c:"steady", t:"<b>Denmark</b> proposes \u201ce-invoicing by default\u201d rather than a B2B mandate \u2014 registered digital bookkeeping systems must auto-register customers in Nemhandel (four-week opt-out), default to electronic sending and verify identity via MitID. Existing customers to be notified by Nov 30, 2026; most rules effective Jan 1, 2027."},
 {w:"Sept 12, 2026", c:"steady", t:"<b>Spain</b> \u2014 AEAT presents the updated draft Ministerial Order for the public e-invoicing solution (SPFE): UBL 2.5 structures, validation rules, web-service interfaces and status reporting, in force Oct 1, 2026. B2B e-invoicing becomes mandatory Oct 1, 2027 above \u20ac8M turnover and Oct 1, 2028 for everyone else."},
 {w:"Sept 11, 2026", c:"steady", t:"<b>Netherlands</b> confirms its ViDA roadmap and goes past the EU minimum: mandatory e-invoicing for domestic and intra-Community B2B from Jul 1, 2030, digital reporting of domestic transactions from Jul 1, 2031, with draft legislation due in Parliament summer 2027."},
 {w:"Sept 11, 2026", c:"ai", t:"<b>Tungsten Automation</b> (ex-Kofax) is named a Leader in the 2026 Gartner Magic Quadrant for Intelligent Document Processing for the second year running \u2014 a credibility signal landing while its lenders are still negotiating a debt restructuring."},
 {w:"Sept 9, 2026", c:"ai", t:"<b>Medius</b> adds sales &amp; use tax verification to its AP automation with <b>Thomson Reuters ONESOURCE</b> \u2014 vendor-charged US tax recalculated line by line inside the approval workflow before the invoice posts. Billed as the first in a series of tax-engine partner integrations."},
 {w:"Sept 9, 2026", c:"steady", t:"<b>Poland (KSeF)</b> \u2014 the Ministry of Finance publishes API v2.7.1: collective-identifier lookups move to POST (ten at a time), page size doubles to 500, rate limits double, and the invoice-export range widens from 3 months to 100 days. Production deployment Sept 23, 2026."},
 {w:"Sept 9, 2026", c:"ai", t:"<b>Esker</b> introduces its Synergy Agentic Framework for the Office of the CFO \u2014 an agentic-AI layer laid across its finance processes."},
 {w:"Sept 8, 2026", c:"steady", t:"<b>Zetadocs (Equisys)</b> ships the September Expenses update \u2014 receipts forwarded to a mailbox are parsed into draft expenses with vendor, amount and tax extracted, plus iOS 27 support. Delivery &amp; Capture, monthly through July, has published nothing since."},
 {w:"Sept 7, 2026", c:"ai", t:"<b>Microsoft</b> publishes the BC 2026 wave 2 (v29.0) preview notes: the <b>Payables Agent</b> now matches purchase orders on line amounts and expected receipt dates, and the <b>Expense Agent</b> gains AI-based policy validation that flags suspicious or non-compliant items, mileage rates by date and vehicle type, withholding tax, interim approvers, duplicate detection against posted documents and travel requisitions. GA stated for early October 2026."},
 ...
 {w:"Aug 31, 2026", c:"steady", t:"<b>Greece</b> \u2014 mandatory B2B e-invoicing enters phase 2 on Oct 1, 2026, pulling every remaining Greek-established business into scope for domestic B2B inside the myDATA framework, with a transition period to year-end."},
 ...
 {w:"Aug 26, 2026", c:"ai", t:"<b>DocuWare</b> moves IDP result validation into the web client \u2014 splitting, classification and extraction are reviewed and corrected in-app, with confidence thresholds routing only low-confidence documents to a human. Cloud only."},
 {w:"Aug 25, 2026", c:"steady", t:"<b>Medius</b> publishes its 2026 Financial Census (2,386 finance executives in the US, UK, Sweden and France): 87% have let a suspected fraudulent expense pass, average reported invoice-fraud loss is $168,000, and 38% have deployed agentic AI \u2014 but 90% still require a human approval."},
 ...
 {w:"Jul 8, 2026", c:"ai", t:"<b>Payhawk</b> passes <b>$100M ARR</b> after a 24-month \u201cAI-native rebuild\u201d \u2014 159% YoY net-new business, 95% YoY payments volume and ARR per employee up 75% to ~$238K, on ~$120M burned since founding."},
 ...
 {w:"Jul 1, 2026", c:"ai", t:"<b>Expensify</b> expands <b>Concierge AI</b> into expense automation and spend analysis by natural language \u2014 settings configuration, report submission and AI workflow agents in beta."},
 ...
 {w:"June 11, 2026", c:"ai", t:"<b>Pleo</b> launches its agent stack \u2014 Policy Agent live, plus Pleo MCP, AP, Treasury and Accounting agents in beta from July \u2014 pitching \u201cspend that runs itself\u201d to 40,000+ businesses. Layoffs of ~50 staff follow a day later."},
 {w:"June 10, 2026", c:"cons", t:"<b>Visma Acubiz</b> takes over Swedish <b>Dicom Expense</b> (previously under Visma’s Belgian Mobile Expense), adding ~1,500 Swedish customers and consolidating Visma’s Nordic expense-management brands under Acubiz."},
 ...
 {w:"June 8, 2026", c:"ai", t:"<b>Expensify</b> ships an <b>MCP</b> server \u2014 ChatGPT, Claude, Cursor and other MCP clients can query expense data directly. <b>Rydoo</b> follows with its own MCP connector, moving expense approvals inside the assistant for customers in 130+ countries."},
 ...
 {w:"Apr 28, 2026", c:"steady", t:"<b>DocuWare</b> (Ricoh) is named a <b>Challenger</b> in the 2026 Gartner Magic Quadrant for Document Management \u2014 21,000+ customers, with messaging built around automated invoice processing."},
 ...
 {w:"Jan 21, 2026", c:"cons", t:"<b>Truvio</b> launches its unified Dynamics 365 platform — ExFlow, Axtension, DynamicWeb and SKsoft merged into one Microsoft-native suite (5,000+ customers, 400+ employees, 300+ partners)."},
 ...
 {w:"Oct 7, 2025", c:"cons", t:"<b>Medius</b> put in play — owner Marlin Equity weighs a sale at a ~$2B valuation with Evercore mandated; a formal process could open in 2026."},
...
(function(){
  var DASHBOARD_UPDATED = "2026-09-17";
