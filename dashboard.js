...
const contentIdeas = [
 {type:"AI narrative", score:89, fmt:["Blog","Webpage","Social"],
  title:"'Ask-anything' finance agents are here - but who approved the invoice?",
  tease:"Use the wave of agentic-analyst launches as the hook, then show where BC-native governance, audit trails and approval control still decide production readiness.",
  reason:"Agentic AI is now the loudest offensive theme in the set. Stampli launched 'an agentic financial analyst you can ask anything' - its single highest-engagement post of the window (145 reactions, 21 reposts) - and declared 'the death of the dashboard' (82 reactions, 23 reposts). Dooap Studio, Tipalti ('the questions finance leaders are asking about AI have changed', 127 reactions) and Medius push the same autonomous story. Continia's credible counter: AI can suggest and extract, but traceability, approval control and native Business Central context are what make AP production-safe.",
  s:[["Stampli Deep Finance","https://www.prnewswire.com/news-releases/stampli-launches-deep-finance-turning-invoice-data-into-executive-spend-intelligence-302729234.html"],["Dooap Studio","https://www.prnewswire.com/news-releases/dooap-inc-launches-dooap-studio-putting-agentic-ap-automation-directly-in-the-hands-of-finance-teams-302768534.html"],["Tipalti finance AI","https://tipalti.com/accounts-payable-software/finance-ai/"],["Continia Document Capture","https://www.continia.com/solutions/document-capture/"]]},
 {type:"Analyst signal", score:88, fmt:["Blog","Webpage","Newsletter"],
  title:"Gartner, Forrester and the Business Central blind spot in 2026",
  tease:"Medius just took a Gartner MQ Leader spot and Forrester crowned Basware - but none of the ranked vendors are BC-native. Translate their own criteria into a BC buyer's guide.",
  reason:"Third-party validation is travelling: Medius's 2026 Gartner Magic Quadrant Leader news and its Gartner Symposium day-one recap (108 reactions) were among its top posts, and Forrester's AP Invoice Automation Wave Q2 2026 named Basware a Leader. Both evaluate enterprise, multi-ERP suites - not embedded BC solutions - which is exactly the opening: a clear-eyed readout that reframes selection around accuracy, exception handling and compliance for a BC finance team.",
  s:[["Medius Gartner MQ 2026","https://www.prnewswire.com/news-releases/medius-placed-in-2026-gartner-magic-quadrant-for-accounts-payable-applications-302807993.html"],["Forrester Wave announcement","https://www.forrester.com/blogs/announcing-the-forrester-wave-accounts-payable-invoice-automation-software-q2-2026/"],["Basware named a Leader","https://www.basware.com/en/resources/the-forrester-wave-accounts-payable-invoice-automation-software-q2-2026"],["Continia Document Capture","https://www.continia.com/solutions/document-capture/"]]},
 {type:"Original research", score:86, fmt:["Report","Blog","Social"],
  ...
  reason:"Rillion keeps mining its Nordic AI Finance Report (250 CFOs) and the derivative stat posts still perform: '26% of CFOs say lack of AI competence is the biggest barrier', '40% see fraud detection as the biggest AI opportunity', '48% want to be strategic advisors'. Original data travels on LinkedIn far better than product posts, yet no BC-native vendor owns a finance-AI research franchise. A BC-specific readiness survey gives Continia credible, quotable numbers and a recurring content engine.",
  s:[["Rillion AI in Finance report","https://www.rillion.com/blog/finance-labs/ai-in-finance-report/"],["Rillion (LinkedIn)","https://www.linkedin.com/company/rillion/"],["Continia Document Capture","https://www.continia.com/solutions/document-capture/"]]},
 {type:"E-invoicing", score:86, fmt:["Blog","Webpage","Newsletter"],
  title:"Mandate map 2026: France, the UAE, Belgium - the BC readiness checklist",
  ...
  reason:"E-invoicing is going global and compliance-critical at once: France's mandate hits large and mid-size firms from September 2026 (DGFiP confirmed, with an informal grace period), the UAE rollout began 1 July 2026 (accredited providers like Pagero already listed), Belgium mandates Peppol from January 2026 and Slovakia's eFaktura framework is live. Rivals are already farming this - B2Brouter's multi-country posts, Qvalia's Slovakia certification, Medius framing e-invoicing as a 'competitive edge'. A BC-focused readiness guide positions Continia against the connector crowd.",
 ...
 {type:"Trust & security", score:85, fmt:["Blog","Webpage","Social"],
  title:"ISO 27001, eIDAS and the audit trail: the AP due-diligence checklist",
  tease:"Turn security and compliance credentials into a buyer's checklist - the exact angle that keeps earning Continia its biggest LinkedIn moments.",
  reason:"Continia's 'We're ISO 27001 certified' post remains one of its top performers (196 reactions in the latest window). Rivals are racing on trust too - Qvalia added ISO 22301 and a Cloud Security Alliance STAR listing, AMC Banking earned its own SWIFT BIC. With AP data increasingly flowing through third-party payment networks, a checklist piece (ISO 27001, eIDAS sealing, Peppol-certified delivery, audit trail, data residency) turns Continia's Trust Center and Delivery Network into proof rather than marketing.",
 ...
 {type:"Milestone / culture", score:84, fmt:["Social","Video","Newsletter"],
  title:"20+ years, 500+ live solutions: the trust story competitors can't fake",
  tease:"Package Continia's heritage and install base - years in the channel, +500 implemented solutions, MVPs and team culture - into a repeatable brand-trust series.",
  reason:"Continia's highest-engagement posts of the window were not product posts but people and milestones: 'Our biggest team meetup yet' (233 reactions), 'Celebrating our very own Microsoft MVP' (217 reactions, 17 comments), 'Happy birthday to our CEO' (208 reactions, 20 comments) and '+500 aktive Continia-losninger' (75). In a category selling on AI hype, longevity and a real install base are a differentiator that resonates - and it's ownable, recurring content no competitor can copy.",
 ...
 {type:"Product release", score:83, fmt:["Blog","Video","Webinar"],
  title:"What 2026 R1 actually changes for AR automation in Business Central",
  tease:"Turn the 2026 R1 release into a benefits-first story anchored on AR automation, not a feature list.",
  reason:"Continia's '2026 R1: a big step forward for AR automation' (84 reactions) and 'Celebrating the first release of 2026' (80) were strong on LinkedIn, yet the matching R1 videos on the YouTube channel are underperforming (24-71 views). The gap says the release lands better as an outcome story than a walkthrough: a blog plus short that leads with what R1 removes from an AR team's day, then links the deeper demo.",
 ...
 {type:"Product demo", score:82, fmt:["Video","Webpage","Webinar"],
  ...
  reason:"The strongest Continia fit is still practical product education. This idea converts existing AP automation pages into a clean demo narrative - import, OCR, register, approve and archive - with the BC-native flow as the proof point. It also feeds the channel's proven strength: product demos and how-tos are Continia's top-viewed videos.",
 ...
 {type:"Analytics", score:80, fmt:["Blog","Social","Newsletter"],
  ...
  reason:"Stampli is doubling down on insight: 'we're about to see the death of the dashboard' (82 reactions, 23 reposts) and Deep Finance reframing invoice data as 'consultant-grade executive spend intelligence' (46 reactions, 29 reposts), funded by a $61M Blackstone round. Continia can meet this by showing how Document Capture data lives natively in Business Central and feeds dimensions, reporting and Power BI - insight without leaving the ERP.",
 ...
 {type:"Product demo", score:79, fmt:["Video","Social","Webpage"],
  ...
  tease:"A short, visual walkthrough of approving on the go - answering a workflow competitors are actively marketing and the channel's audience already loves.",
  reason:"Mobile is a proven winner on Continia's own channel - 'Mobile App - Expense Management' is its #1 all-time video (6,071 views) - and rivals are marketing it too (Qvalia's 'now available on iPhone and Android' post, 42 reactions, 5 comments). Continia can tell the same story inside Business Central with its approval workflow and web/mobile approval, keeping the proof BC-native instead of a separate app.",
 ...
 {type:"Event marketing", score:78, fmt:["Social","Video","Newsletter"],
  title:"Turn Elevate, Directions and DynamicsMinds into a content engine",
  ...
  reason:"Event posts keep dominating engagement: Continia's Elevate Poland stop (71) and DynamicsMinds catch-up (66), Yavrio's DynamicsMinds recap (108) and DynamicsCon (99), Stampli's Sage Future day one (91) and Rillion's DynamicsCon (52). That is a format insight, not a one-off - a planned template for every Continia event (Elevate, Directions, Community Summit) turns presence into a reliable engagement stream.",
 ...
 {type:"Positioning", score:76, fmt:["Blog","Social"],
  ...
  reason:"The category keeps moving toward payment monetisation and financial networks: Yavrio launched embedded Cards inside Microsoft Dynamics (131 reactions), Tipalti is signalling an IPO path, and Stampli's fresh $61M Blackstone round funds more of the same. Continia can contrast a focused, Business Central-native position - no payment-rail incentive, one ledger, one audit trail - without sounding defensive.",
  s:[["AvidXchange acquisition","https://www.avidxchange.com/press-releases/tpg-corpay-complete-acquisition-of-avidxchange/"],["Stampli $61M raise","https://financialit.net/news/fundraising-news/stampli-secures-61m-advanced-ai-powered-ap-automation"],["Yavrio (LinkedIn)","https://www.linkedin.com/company/yavrio/"]]},
 {type:"Document Output", score:73, fmt:["Blog","Webpage"],
  ...
  reason:"Lasernet - now independent as Lasernet Group and live on BC AppSource with Azure AI mapping - is visible in the BC-native output space, while Continia Document Output has strong material around automated distribution, protected PDFs, eIDAS and AI-powered translations. On the channel, 'Document Output - Solution demo intro' is a top-five all-time video (5,604 views), confirming appetite for this adjacent pillar for buyers thinking beyond invoice intake.",
